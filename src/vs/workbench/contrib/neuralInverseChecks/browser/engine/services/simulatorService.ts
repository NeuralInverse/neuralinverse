...
import { ISimulatorSession, ISimulatorPreset, ISimulatorSessionConfig } from './simulatorTypes.js';
...
export interface ISimulatorService {
	...
	createSession(config: ISimulatorSessionConfig): Promise<ISimulatorSession>;
