...
import { IEnclaveFirewallService } from '../../neuralInverseEnclave/browser/services/enclaveFirewallService.js';
...
export class LLMMessageService extends Disposable implements ILLMMessageService {
	...
	sendLLMMessage(params: ServiceSendLLMMessageParams) {
		...
		if (modelSelection === null) {
			const message = `Please add a provider in Neural Inverse LLM Settings.`
