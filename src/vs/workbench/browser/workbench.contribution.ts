	...
	registry.registerConfiguration({
		...
		'properties': {
			...
			'workbench.sideBar.location': {
				...
				'enum': ['left', 'right'],
				'default': 'left',
				'description': localize('sideBarLocation', "Controls the location of the primary side bar and activity bar. They can either show on the left or right of the workbench. The Neural Inverse side bar will show on the opposite side of the workbench.")
			},
			...
			[LayoutSettings.ACTIVITY_BAR_LOCATION]: {
				...
				'enum': ['top'],
				'default': 'top',
				'markdownDescription': localize({ comment: ['This is the description for a setting'], key: 'activityBarLocation' }, "Controls the location of the Activity Bar relative to the Primary and Neural Inverse side bars."), // Neural Inverse side bar
				'enumDescriptions': [
					localize('workbench.activityBar.location.top', "Show the Activity Bar on top of the Primary and Neural Inverse side bars."), // Neural Inverse side bar
				],
			},
...
Registry.as<IConfigurationMigrationRegistry>(Extensions.ConfigurationMigration)
	.registerConfigurationMigrations([{
		key: LayoutSettings.ACTIVITY_BAR_LOCATION, migrateFn: (value: unknown) => {
			...
			if (value === 'side' || value === 'default') {
				results.push([LayoutSettings.ACTIVITY_BAR_LOCATION, { value: ActivityBarPosition.TOP }]);
			}
			return results;
		}
	}]);
